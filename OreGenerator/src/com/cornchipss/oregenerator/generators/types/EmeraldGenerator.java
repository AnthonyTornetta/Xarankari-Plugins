...
{
	public EmeraldGenerator(Block generatorBlock, OreGeneratorPlugin plugin, List<GeneratorUpgrade> upgrades) 
	{
		super(new Vector3(3, 3, 3), 7, GeneratorUtils.GENERATOR_EMERALD_ID, generatorBlock, plugin, upgrades);
	}
	
	public EmeraldGenerator(Block generatorBlock, OreGeneratorPlugin plugin) 
	{
		super(new Vector3(3, 3, 3), 7, GeneratorUtils.GENERATOR_EMERALD_ID, generatorBlock, plugin);
	}
