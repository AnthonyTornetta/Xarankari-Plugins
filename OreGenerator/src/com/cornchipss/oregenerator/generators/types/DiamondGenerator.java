...
{
	public DiamondGenerator(Block generatorBlock, OreGeneratorPlugin plugin, List<GeneratorUpgrade> upgrades) 
	{
		super(new Vector3(3, 3, 3), 6, GeneratorUtils.GENERATOR_DIAMOND_ID, generatorBlock, plugin, upgrades);
	}
	
	public DiamondGenerator(Block generatorBlock, OreGeneratorPlugin plugin) 
	{
		super(new Vector3(3, 3, 3), 6, GeneratorUtils.GENERATOR_DIAMOND_ID, generatorBlock, plugin);
	}
